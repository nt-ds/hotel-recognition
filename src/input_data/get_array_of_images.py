...
def get_array_of_images(image_folder_in_int, is_training=True, image_type="unoccluded"):
    '''
    ...
    if is_training:
        path = f"drive/My\ Drive/hotel-recognition/data/raw/training/{image_folder_in_int}"
    else:
        path = f"drive/My\ Drive/hotel-recognition/data/raw/test/{image_type}/{image_folder_in_int}"
